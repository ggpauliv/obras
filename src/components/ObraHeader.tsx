...
const OBRA = {
  nome: 'Edifício Horizonte — Torre A',
  cliente: 'Construtora Meridional S.A.',
  responsavel: 'Eng. Carlos Motta',
  tipo: 'Residencial',
...
const INFO: Array<[string, string, string]> = [
  ...
  ['person', 'Responsável', OBRA.responsavel],
  ['apartment', 'Tipo', OBRA.tipo],
  ['location_on', 'Local', OBRA.endereco],
];
      ...
      <div className="bg-primary-container text-on-primary rounded-xl p-lg ambient-shadow relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col gap-sm">
          <div className="flex items-center gap-md flex-wrap">
            <h2 className="text-display-lg-mobile md:text-display-lg text-on-primary">{OBRA.nome}</h2>
